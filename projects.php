...
<div class="container-fluid" id="projects">
	...
	<div class="container bg-light py-5 rounded shadow-lg">
		...
		<div class="d-flex w-100 flex-wrap justify-content-evenly">
			...
			<?php foreach ($projects as $project) { ?>
				<div class="card m-4 grow grow:hover rounded-3 shadow-lg project-box w-25" style="min-width: 300px">
					<div class="card-body d-flex flex-column justify-content-center">
						<h5 class="card-title h5 text-center"><?php echo $project['projectTitle']; ?></h5>
						...
						<h1 class="text-center text-dark">
							<a href="<?php echo $project['liveSite'] ?>" target="_blank"><i class="bi bi-globe2 m-1 text-dark project-link"></i></a>
							<a href="<?php echo $project['repo'] ?>" target="_blank"><i class="bi bi-github m-1 text-dark"></i></a>
						</h1>
					</div>
				</div>
			<?php }; ?>
